...
class SessionAdapter(private val sessionList: List<Session>, private val bundle: Bundle) :
    ...
    override fun onBindViewHolder(holder: SessionViewHolder, position: Int) {
        ...
        holder.tvSlots.text = if (AppConstants.STRING_TO_DOSE_MAP[bundle.getString(AppConstants.DOSE, "")].equals("1st")) {
            eachSession.available_capacity_dose1.toString()
        } else {
            eachSession.available_capacity_dose2.toString()
        }
